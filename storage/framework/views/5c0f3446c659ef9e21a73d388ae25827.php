...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('assets/images/favicon.ico')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/vendors/ion.rangeSlider.min.css ')); ?>">
    ...
    <link id="color-link" rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/demo4.css ')); ?>">
    <style>
       .h-logo {
    ...
    header .brand-logo img {
        max-width: 50%; /* Ensure the logo within the header takes full width */
        height: 67px; /* Maintain aspect ratio */
    }

    /* Additional styles for the profile dropdown */
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="index.htm">
                                        <img src="assets/images/logo.jpg" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="<?php echo e(route('app.index')); ?>" class="nav-link menu-title">Home</a></li>
                                            <li><a href="<?php echo e(route('shop.index')); ?>" class="nav-link menu-title">Shop</a></li>
                                            <li><a href="<?php echo e(route('cart.index')); ?>" class="nav-link menu-title">Cart</a></li>
                                            <li><a href="<?php echo e(route('aboutUs.index')); ?>" class="nav-link menu-title">About Us</a></li>
                                            <li><a href="<?php echo e(route('contact.index')); ?>" class="nav-link menu-title">Contact Us</a>
                                            </li>
                                            <li><a href="<?php echo e(route('blog.index')); ?>" class="nav-link menu-title">Blog</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                                ...
                                <ul>
                                    ...
                                    <li class="onhover-dropdown wislist-dropdown">
                                        <div class="cart-media">
                                            <a href="<?php echo e(route('wishlist.list')); ?>">
...
<li class="onhover-dropdown">
    <div class="cart-media name-usr">
        <?php if(auth()->guard()->check()): ?> <span><?php echo e(Auth::user()->name); ?></span> <?php endif; ?> <i data-feather="user"></i>
    </div>
            ...
            <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->utype === 'ADM'): ?>
                        <li>
                            <a href="<?php echo e(route('admin.index')); ?>" class="d-block">Dashboard</a>
                        </li>
                    <?php else: ?>
                        <li>
                            <a href="<?php echo e(route('user.index')); ?>" class="d-block">My Account</a>
                        </li>
                    <?php endif; ?>
                    <li>
                        <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('frmlogout').submit();" class="d-block">Logout</a>
                        <form id="frmlogout" action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                        </form>
                    </li>
                <?php else: ?>
                    <li>
                        <a href="<?php echo e(route('login')); ?>" class="d-block">Login</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('register')); ?>" class="d-block">Register</a>
                    </li>
                <?php endif; ?>                                                    
            <?php endif; ?>
        </ul>
...
<div class="search-full">
    <form method="GET" class="search-full" action="<?php echo e(route('search')); ?>">
   ...
   <?php echo $__env->yieldContent('content'); ?>
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="<?php echo e(asset('assets/images/logo.png')); ?>" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +92 0000000000</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> KICSIT Kahuta,Rawalpindi
                                          Pakistan</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> abc123@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, CE-7 Project</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?php echo e(asset('assets/js/slick/slick-animation.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/slick/custom_slick.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/price-filter.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/cart_modal_resize.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bootstrap/bootstrap-notify.min.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\laravel_ecommerce\resources\views/layouts/base.blade.php ENDPATH**/ ?>