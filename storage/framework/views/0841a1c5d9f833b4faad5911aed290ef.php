...
<?php $__env->startPush('styles'); ?>
    <link id="color-link" rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/demo2.css')); ?>">
<?php $__env->stopPush(); ?>
...
<section>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="details-image-vertical black-slide rounded">
                                        ...
                                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div>
                                                <img src="<?php echo e(asset('assets/images/fashion/product/front')); ?>/<?php echo e($image); ?>"
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <img src="<?php echo e(asset('assets/images/fashion/product/front')); ?>/<?php echo e($product->image); ?>" class="img-fluid w-100 image_zoom_cls-0 blur-up lazyload" alt="<?php echo e($product->name); ?>">
                                        </div>
                                        ...
                                        <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div>
                                                <img src="<?php echo e(asset('assets/images/fashion/product/front')); ?>/<?php echo e($image); ?>" class="img-fluid w-100 image_zoom_cls-1 blur-up lazyload" alt="">
                                            </div>                                            
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                        <?php endif; ?>                                                                                  
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">
                                    ...
                                    <del>$<?php echo e($product->regular_price); ?></del><span>
                                        <?php echo e(round((($product->regular_price - $product->sale_price)/$product->regular_price)*100)); ?>
    ...
    <form id="addtocart" method="post" action="<?php echo e(route('cart.store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel_ecommerce\resources\views/details.blade.php ENDPATH**/ ?>