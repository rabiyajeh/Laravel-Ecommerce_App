...
<section class="breadcrumb-section section-b-space" style="padding-top:20px;padding-bottom:20px;">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse show"
            ...
            <ul class="category-list">
                ...
                <li>
                    <div class="form-check ps-0 custome-form-check">
                        <input class="checkbox_animated check-it" id="br<?php echo e($brand->id); ?>" name="brands" <?php if(in_array($brand->id,explode(',',$q_brands))): ?> checked="checked" <?php endif; ?> value="<?php echo e($brand->id); ?>" type="checkbox" onchange="filterProductsByBrand(this)">
                        <label class="form-check-label"><?php echo e($brand->name); ?></label>


                        <p class="font-light">(<?php echo e($brand->products->count()); ?>)</p>
                    </div>
                </li>
      ...
      <select class="form-select" name="size" id="pagesize">
            <option value="12" <?php echo e($size == 12 ? 'selected':''); ?>>12 Products Per Page</option>


            <option value="24" <?php echo e($size == 24 ? 'selected':''); ?>>24 Products Per Page</option>


            <option value="52" <?php echo e($size == 52 ? 'selected':''); ?>>52 Products Per Page</option>
            <option value="100" <?php echo e($size == 100 ? 'selected':''); ?>>100 Products Per Page</option>
      </select>
</div>
                                </div>
        ...
        <div class="product-box">
            <div class="img-wrapper">
                <div class="front">
                    <a href="<?php echo e(route('shop.product.details',['slug'=>$product->slug])); ?>">
                        <img src="assets/images/fashion/product/front/<?php echo e($product->image); ?>"
                            class="bg-img blur-up lazyload" alt="">
                    </a>
                </div>
                <div class="back">
                    <a href="<?php echo e(route('shop.product.details',['slug'=>$product->slug])); ?>">
                        <img src="assets/images/fashion/product/back/<?php echo e($product->image); ?>"
                            class="bg-img blur-up lazyload" alt="">
                    </a>
                </div>
                <div class="cart-wrap">
            ...
            <div class="product-details">
                <div class="rating-details">
                    <span class="font-light grid-content"><?php echo e($product->category->name); ?></span>
                ...
                <div class="main-price">
                    <a href="<?php echo e(route('shop.product.details',['slug'=>$product->slug])); ?>" class="font-default">
                        <h5 class="ms-0"><?php echo e($product->name); ?></h5>
                    </a>
                    <div class="listing-content">
                        <span class="font-light"><?php echo e($product->category->name); ?></span>
                        <p class="font-light"><?php echo e($product->short_description); ?></p>
                    </div>
                    <h3 class="theme-color">$<?php echo e($product->regular_price); ?></h3>
...
<?php echo e($products->links()); ?>
    ...
    <input type="hidden" id="brands" name="brands" value="<?php echo e($q_brands); ?>" />  
</form>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make("layouts.base", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel_ecommerce\resources\views/shop/shop.blade.php ENDPATH**/ ?>