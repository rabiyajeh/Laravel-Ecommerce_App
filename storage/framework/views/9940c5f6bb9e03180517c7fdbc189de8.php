                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            <div class="brand-logo">
                                <a href="index.php">                                        
                                    <img src="assets/images/logo.png" class="h-logo img-fluid blur-up lazyload" alt="logo">
                                </a>
                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3">
                                                            <div class="category-childmenu">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">Dress</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">Skirts</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">Western
                                                                            wear</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">Etahnic
                                                                            wear</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">Sports
                                                                            wear</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="category-childmenu">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">earrings</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">fashion
                                                                            jewellery</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">ties</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">caps and
                                                                            hats</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">cufflinks</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">precious
                                                                            jewellery</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop-left-sidebar.php">necklaces</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                            ...
                            <div class="main-navbar">
                                <div id="mainnav">
                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        <li><a href="index.php" class="nav-link menu-title">Home</a></li>
                                        <li><a href="shop.php" class="nav-link menu-title">Shop</a></li>   
                                        <li><a href="cart.php" class="nav-link menu-title">Cart</a></li>                                                                                 
                                        <li><a href="about-us.php" class="nav-link menu-title">About Us</a></li>
                                        <li><a href="contact-us.php" class="nav-link menu-title">Contact Us</a></li>
                                        <li class="dropdown">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                ...
                                                <li>
                                                    <a href="blog-infinite-scroll.php">Blog Infinite Scroll</a>
                                                </li>                                               
                                            </ul>
                                        </li>
                            ...
                            <ul>
                                ...
                                <li class="onhover-dropdown">
                                    ...
                                    <div class="onhover-div profile-dropdown">
                                        <ul>
                                            <li>
                                                <a href="my-account.php" class="d-block">My Account</a>
                                            </li>
                                            <li>
                        ...
                        <div class="modal-product">
                            ...
                            <div class="modal-contain-details">
                                ...
                                <div class="shop-cart-button mt-3">
                                    <a href="shop-left-sidebar.php" class="btn default-light-theme conti-button default-theme default-theme-2 rounded">CONTINUE
                                        SHOPPING</a>
                                    <a href="cart.php" class="btn default-light-theme conti-button default-theme default-theme-2 rounded">VIEW
                                        CART</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\laravel_ecommerce\resources\views/myaccount.blade.php ENDPATH**/ ?>